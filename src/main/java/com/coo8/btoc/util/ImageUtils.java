...
public class ImageUtils {
	...
	public static void main(String[] args) {
		...
		try {
			is.saveImageAsJpg("C:/Documents and Settings/coo8/桌面/newimage.png", 
					"C:/Documents and Settings/coo8/桌面/m1_1.png", 70, 22);
		} catch (Exception e) {
	...
	/**
	 * 添加生成缩略图
	 * @param fromFile 源文件（图片）
	 * @param saveToFileStr 新图片地扯
	 * @param formatWideth 新图片宽
	 * @param formatHeight 新图片高
	 * @throws IOException 源文件转换成图片出错（非图片）
	 */
	public void saveImageAsJpg(File fromFile, String saveToFileStr,
	 ...
	 * @throws IOException
	 */
	public void saveImageAsJpgBySize(File fromFile, String saveToFileStr,
			int formatWideth, int formatHeight) throws IOException{
	...
	public void saveImageAsJpg(String fromFileStr, String saveToFileStr,
		...
		this.saveImageAsJpg(fromFile, saveToFileStr, formatWideth, formatHeight);
	}
