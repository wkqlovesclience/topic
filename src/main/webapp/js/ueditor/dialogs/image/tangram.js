...
baidu.swf.createHTML = function(s) {
	...
	var m = s.vars, l = [ "classid", "codebase", "id", "width", "height",
			"align" ];
...
baidu.flash._Base = (function() {
	...
	function a(g) {
		if (typeof g !== "undefined" && typeof g.flashInit !== "undefined"
				&& g.flashInit()) {
			return true
		} else {
			return false
	...
	return function(q, i) {
		var n = this, h = (typeof q.autoRender !== "undefined" ? q.autoRender
				: true), p = q.createOptions || {}, l = null, m = false, k = [], g = null, i = i
				|| [];
		n.render = function() {
			l = e(p);
			if (i.length > 0) {
...
baidu.flash.imageUploader = baidu.flash.imageUploader
		|| function(a) {
			var b = this, a = a || {}, c = new baidu.flash._Base(a, [
					"selectFileCallback", "exceedFileCallback",
