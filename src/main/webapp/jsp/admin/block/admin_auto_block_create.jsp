     ...
     <div class="RightBg">
		  ...
		  <div class="RightTabTags">
						         	...
						         	<tr>
							           ...
							           <td style="width:80px;border-bottom:none;" class="TextCen GDray LBoder fB">
							            ...
							            <td style="width:110px;border-bottom:none;" class="TextCen GDDDray Boder fB">
							           		<a style="color:white" href="${ctx}/admin/block/autoCreateRequest.action">新建自动块</a>
							           	</td>
							           	<td>&nbsp;</td>
						           	</tr>
						    </table>
						  ...
						  <form action="${ctx}/admin/block/createCommonManualBlock.action" method="post" enctype="multipart/form-data" id="blockFormId" onsubmit="YUTIL.trimFormVal(this.id)">
								...
								<tr>
									<td class="TextRig DText" style="width:10%;">名字：</td> 
								...
								<tr>
									<td class="TextRig DText">显示名字：</td> 
									<td class="TextLeft DText">
										<input type="text" style="width:524px;text-align: left;" class="inbox" maxlength="30" name="block.displayName" id="name" />
									</td> 
								</tr>
								<tr>
									<td class="TextRig DText">描述：</td> 
									<td class="TextLeft DText">
										<textarea onkeydown="if (this.value.length&gt;=500){if(event.keyCode != 8) event.returnValue=false;}" style="width:824px;" rows="6" class="mulinbox1" name="block.description" id="description"></textarea>
									</td> 
								</tr>
								<tr>
