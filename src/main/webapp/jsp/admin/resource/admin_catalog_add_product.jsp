				...
				<tr>
      				<td>
      					<div class="RightBg">
						    ...
						    <table cellspacing="0" cellpadding="0">
						         	<tr>
							           ...
							           <td style="width:77px;border-bottom:none;" class="TextCen GDDDray Boder fB">
						  ...
						  <div class="RightTab">
								...
								<tr>
								<td style="width:140px" class="TextCen fB GDDray LBodRit DText">分类</td>
								<td class="TextCen fB GDDray LBodRit DText">产品</td>
								<td style="width:260px" class="TextCen fB GDDray DText">操作</td>
								</tr>
										<s:iterator var="rc" value="resourceCatalogList">
											...
											<td class="TextCen DText LBodTop LBodRit" id="catalog_product_<s:property value='#rc.catalogId'/>">
												<s:property value="productIds"/>											
											</td>
											<td class="TextCen DText LBodTop">
												<a href="${ctx}/admin/items/selcondition.action?t_resourceId=<s:property value='resourceId' />&t_catalogId=<s:property value='#rc.catalogId' />&catbigid=<s:property value='#rc.catalogId' />&t_type=1&showstatus=1" >继续添加</a>
												|
												<a href="javascript:;" class="product_show_a" tid="<s:property value='#rc.id' />" >查看产品</a>
												|
												<a href="javascript:deleteResourceCatalog('<s:property value='#rc.catalogId' />', '<s:property value='#rc.resourceId' />', <s:property value='#rc.type' />);">删除</a>											</td>
											</tr>
										...
										<tr>
											<td colspan="3" class="TextLeft LBodTop">
												...
												<input value="添加产品.." type="button" onclick="checkCatalogBeforeSelectProduct();"/>											</td>
										</tr>
								</table>
						 </div>
     				</div>
...
function checkCatalogBeforeSelectProduct() {
	...
	window.location.href="${ctx}/admin/items/selcondition.action?t_resourceId=" 
				...
				+"&catbigid="+$("#bigCatalogId").val()+"&t_type=1&showstatus=1";
}
