     ...
     <td>
       <div class="RightBg">
	        <div class="H10"></div>
						         	...
						         	<tr>
							           ...
							           <td style="width:108px;border-bottom:none;" class="TextCen GDray Boder fB">
							           	...
							           	<td style="width:122px;border-bottom:none;" class="TextCen GDDDray Boder fB">
							           		<a style="color:white" href="${ctx}/jsp/admin/resource/admin_outside_resource_create.jsp">新建外部数据源</a>
							           	</td>
							           	<td>&nbsp;</td>
						           	</tr>
						  	</table>
						  ...
						  <div class="RightTab">
							<form action="${ctx}/admin/resource/createOutsideResource.action" method="post" id="resourceFormId" onsubmit="YUTIL.trimFormVal(this.id)">
								<table cellpadding="0" cellspacing="0"> 
								<tr>
									<td class="TextRig">名字：</td> 
									<td class="TextLeft">
										<input type="text" style="width:524px;" class="inbox" maxlength="255"  name="resource.name" id="name" />
									</td> 
								</tr>
								<tr>
									<td class="TextRig" style="width:10%">代码：</td> 
									<td class="TextLeft">
