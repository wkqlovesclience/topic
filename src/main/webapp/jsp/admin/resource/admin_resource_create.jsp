     ...
     <div class="RightBg">
			<div class="H10"></div>
					<div class="RightTabTags">
						    <table cellspacing="0" cellpadding="0">
						         	<tr>
							           ...
							           <td style="width:122px;border-bottom:none;" class="TextCen GDDDray Boder fB">
							           		<a style="color:white" href="${ctx}/jsp/admin/resource/admin_resource_create.jsp">新建程序数据源</a>
							           	</td>
							           <td style="width:5px"></td>
                                       <td style="width:122px;border-bottom:none;" class="TextCen GDray Boder fB">
						  ...
						  <div class="RightTab">
							<form action="${ctx}/admin/resource/create.action" method="post" id="resourceFormId" onsubmit="YUTIL.trimFormVal(this.id)">
								<table cellpadding="0" cellspacing="0"> 
								<tr>
								...
								<tr>
									...
									<td class="TextLeft">
										<input type="text" style="width:524px;" class="inbox" maxlength="255"  name="resource.resource" id="name" >
									</td> 
								</tr>
								<tr>
									<td class="TextRig">测试代码：</td> 
									<td class="TextLeft">
										<input type="text" style="width:524px;" class="inbox" maxlength="255"  name="resource.testCode" id="name" >
									</td> 
								</tr>
								<tr>
								...
								<tr>
									<td colspan="2" class="TextCen">
										<input type="submit" value="保存"/>&nbsp;&nbsp;<input type="button" value="返回" onclick="window.location.href='/admin/resource/list.action'"/>
									</td>
								</tr>
								</table>
							</form>
