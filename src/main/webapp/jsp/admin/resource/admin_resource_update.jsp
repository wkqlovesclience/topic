		  ...
		  <div class="H10">
						         	...
						         	<tr>
							           ...
							           <td style="width:108px;border-bottom:none;" class="TextCen GDray Boder fB">
							            ...
							            <td style="width:108px;border-bottom:none;" class="TextCen GDray Boder fB">
							           	...
							           	<td style="width:5px;"></td>
							            <td style="border-bottom:none; width:156x" class="TextCen GDDDray Boder fB">
						  ...
						  <div class="RightTab">
							<form action="${ctx}/admin/resource/update.action" method="post" id="templateForm">
								...
								<tr>
									<td class="TextRig DText">测试代码：</td> 
									<td class="TextLeft DText">
										<input type="text" style="width:524px;" class="inbox" maxlength="100"  value="<s:property value='resource.testCode' />" name="resource.testCode" id="name" >
									</td> 
								</tr>
								<tr>
								...
								<tr>
									<td class="TextRig DText">数据源文档：</td> 
									<td class="TextLeft DText">
