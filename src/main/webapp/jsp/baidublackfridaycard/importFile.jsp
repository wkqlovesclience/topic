		...
		<div class="mod-1">
			...
			<div class="bd clearfix">
				<div style="margin-bottom: 10px;" class="container-1">
					添加百度黑五商品： <input type="file" size="50" id="words" name="words" /> 
					<input type="hidden" id="fileType" name="fileType" />
					<input type="button" onclick="checkFile()" value="导入商品"/>
					&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
				    &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
				    &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
								...
								<td>
									<c:choose>
										<c:when test="${log.failCount != 0}">
											<a href="javascript:void(0)" onclick="downErrorList('${log.id}','${log.creator}')" title="下载导入失败的热词列表文件">
