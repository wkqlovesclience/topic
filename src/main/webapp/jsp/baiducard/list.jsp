...
<script type="text/javascript">
	...
	function delBaiDuCards() {
		...
		if(confirm('确认删除？')){
		   window.location.href = "${ctx}/PromotionCard/delete.action?tags=" + str;
		 }
	}
	...
	function tunePage(num) {
		...
		var url = '${ctx}/PromotionCard/list.action?' + 'page_index=' + num;
...
<body>
	<form action="${ctx}/PromotionCard/list.action" method="post" id="f1">
		<div class="mod-1">
			<div class="hd">
				<h3>百度优惠卡管理</h3>
			</div>
			<div class="bd clearfix">
				<div style="margin-bottom: 10px;" class="container-1">				 
				  ...
				  <input type="text" class="txt-5" id="id" name="id" value="${id}"/>  
				   &nbsp;&nbsp;编辑状态：
				  <s:select id="isEditor" name="isEditor" list="#{3:'默认',0:'未编辑',1:'已编辑'}" />
				  &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;	
				...
				<div class="container-1">
					...
					<table class="tb-zebra tmp-class" style="width: 100%;">
						...
						<tbody>
							<s:if test="promotionCardList!= null">
								<s:iterator value="promotionCardList"  status="st">
									<tr>
										<td><label> <input type="checkbox" name="cbs"
												id="cbs" value="<s:property value='id' />" /> </label></td>
										<td><s:property value='id' /></td>
										<td ><s:property value='productName' /></td>
										<td ><img align="top" src="${imgUrl}_50.jpg" width="50" height="40" /></td>
										...
										<td> 										
											 <a href="${ctx}/PromotionCard/edit.action?id=<s:property value='id'/>">编辑</a>
											 &nbsp;&nbsp;&nbsp;
											 &nbsp;&nbsp;&nbsp;
											 <a href="${ctx}/PromotionCard/delete.action?tags=<s:property value='id'/>">删除</a>
										</td>
									</tr>
								</s:iterator>
							</s:if>
							...
							<tr>
								...
								<td style="border: 0 none;">
									<div class="numpage-box">
										<div class="numpage">
											<coo8:page name="promotionCardList" style="js" systemId="1" />
										</div>
									</div></td>
							</tr>
						</tfoot>
