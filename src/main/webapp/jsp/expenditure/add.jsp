...
<head>
	...
	<script type="text/javascript">
        ...
        function selectSecond(second) {
            ...
            if(secondIds !=0){
                $.ajax({
                    url: "${ctx}/Expenditure/thirdList_ajax.action?selectSecondIds="+secondIds,
                    type: "get",
                    dataType:"json",
                    success:function(data){
                        for (var i = 0; i < data.length; i++) {
...
<form action="${ctx}/Expenditure/add_Expenditure.action" method="post" id="f1" onsubmit="return verify()">
	<div class="mod-1">
		<div class="hd">
			<h3>添加线上花费</h3>
