							...
							<s:if test="expendAnalyseBaseList!= null">
								<tr>
									...
									<td>
										<erm:authorize code="topic_expenditure_modify">
											<a href="${ctx}/ExpenditureOffLine/ajaxWholeJump.action" target="_blank"/>全站花费折线图查看</a>
										</erm:authorize>
									</td>
								</tr>
								<s:iterator value="expendAnalyseBaseList"  status="ExpendAnalyseBase">
									...
									<s:iterator value="stairChannelAndExpends" status="listmap">
										<tr>
											<s:iterator value="listmap" status="stairChannelAndExpends">
												...
												<td>
													<erm:authorize code="topic_expenditure_modify">
														<a href="${ctx}/ExpenditureOffLine/ajaxJump.action?firstStairId=<s:property value='stairId'/>" target="_blank"/>渠道折线图查看</a>
													</erm:authorize>
												</td>
											</s:iterator>
										</tr>
									...
									<tr>
										...
										<td>
											<erm:authorize code="topic_expenditure_modify">
												<a href="${ctx}/ExpenditureOffLine/ajaxPortJump.action?realPortId=<s:property value='portId'/>" target="_blank"/>端口折线图查看</a>
											</erm:authorize>
										</td>
									</tr>
