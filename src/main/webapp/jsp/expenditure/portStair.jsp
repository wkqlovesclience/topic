...
<html>
	<head>
		...
		<script language="javascript" type="text/javascript">
            function yearChange(value){
                $.post("${ctx}/Expenditure/portExpendAnalyseInMonth.action?yearNum="+value+"&realPortId=<s:property value='realPortId'/>",function(data){
                    console.log(data);
                    // 使用刚指定的配置项和数据显示图表。
                    myChart.setOption({
                        xAxis: {
	...
	<script type="text/javascript">
        ...
        $.post("${ctx}/Expenditure/portExpendAnalyseInMonth.action?realPortId=<s:property value='realPortId'/>",function(data){
            console.log(data);
            // 使用刚指定的配置项和数据显示图表。
            myChart.setOption({
                xAxis: {
