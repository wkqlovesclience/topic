...
<html>
	<head>
		...
		<script language="javascript" type="text/javascript">
            function yearChange(value){
                $.post("${ctx}/Expenditure/expendAnalyseInMonth.action?yearNum="+value+"&stairId=<s:property value='firstStairId'/>",function(data){
                    console.log(data);
                    // 使用刚指定的配置项和数据显示图表。
                    myChart.setOption({
                        xAxis: {
	...
	<script type="text/javascript">
        ...
        $.post("${ctx}/Expenditure/expendAnalyseInMonth.action?stairId=<s:property value='firstStairId'/>",function(data){
            console.log(data);
            // 使用刚指定的配置项和数据显示图表。
            myChart.setOption({
                xAxis: {
