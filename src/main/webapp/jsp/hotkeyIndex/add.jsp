...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
  <head>
	...
	function getTitleName(){
	    ...
	    $.post("${ctx}/HotkeyIndex/getTitleName.action?hotkeyId="+hotkeyId,
	        function (msg){
    ...
    <div class="mod-1">
        ...
        <div class="bd clearfix">
            <div class="container-1">
                <form name="hotkeyIndexAddform" action="${ctx}/HotkeyIndex/add.action" method="post" onsubmit="return validateIndexAdd();" onreset="onReset()">
                <table class="tb-1" style="margin-left: 20px;" width="100%">
                    <tbody>
                    <tr>
                        <td>热搜编号：</td>
                        <td>
                        <div style="float: left;"><input type="text" id="hotkey_id" name="hotkeyIndexEntity.hotkeyId" value="" onblur="getTitleName()" /></div>
                        <div id="titleNameDiv" style="float: left;margin-left: 10px;"></div>
                        <input type="hidden" id="title_name" name="hotkeyIndexEntity.hotkeyTitle" value=""/>
                        </td>
                    </tr>
                    <tr>
                        <td width="100">索引：</td>
                        <td><s:select id="hotkeyIndex" name="hotkeyIndexEntity.hotkeyIndex" cssStyle="width:80px;" theme="simple" list="#{'':'','A':'A','B':'B','C':'C','D':'D','E':'E','F':'F','G':'G','H':'H','I':'I','J':'J','K':'K','L':'L','M':'M','N':'N',
                    ...
                    <tr>
                        <td>优先级：</td>
                        <td>
                        <s:select id="priority" name="hotkeyIndexEntity.priority" theme="simple" cssStyle="width:80px;" list="#{'':'','0':'低','1':'中','2':'高'}">
                        </s:select>
                        </td>
                    </tr>
                    <tr>
