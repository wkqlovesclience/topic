...
function getTitleName(){
	...
	$.post("${ctx}/Titles/getTitleName.action?titleId="+titleId,
		function (msg){
  ...
  <div class="mod-1">
	    ...
	    <div class="bd clearfix">
			<div class="container-1">
				<form name="titleIndexAddform" action="${ctx}/Titles/titleIndexAdd.action" method="post" onsubmit="return validateIndexAdd();" onreset="onReset()">
				<table class="tb-1" style="margin-left: 20px;" width="100%">
					<tbody>
					<tr>
						<td>专题编号：</td>
						<td>
						<div style="float: left;"><input type="text" id="title_id" name="titleIndex.titleId" value="" onblur="getTitleName()" /></div>
						<div id="titleNameDiv" style="float: left;margin-left: 10px;"></div>
						<input type="hidden" id="title_name" name="titleIndex.title" value=""/>
						</td>
					</tr>
					<tr>
						<td width="100">索引：</td>
						<td><s:select id="cindex" name="titleIndex.cindex" theme="simple" list="#{'':'','A':'A','B':'B','C':'C','D':'D','E':'E','F':'F','G':'G','H':'H','I':'I','J':'J','K':'K','L':'L','M':'M','N':'N',
					...
					<tr>
						<td>优先级：</td>
						<td>
						<s:select id="priority" name="titleIndex.priority" theme="simple" list="#{'':'','0':'低','1':'中','2':'高'}">
						</s:select>
						</td>
					</tr>
					<tr>
