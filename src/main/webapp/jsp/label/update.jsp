		...
		<div class="line-1"></div>
		 <form name="LabelIndexUpdateform" action="${ctx}/Label/labelIndexUpdate.action" method="post" onsubmit="return validateIndexUpdate();">
			<table class="tb-1" style="margin-left: 30px;" width="400">
				...
				<tr>
				  	<td>&nbsp;优先级&nbsp;：</td>
					<td><s:select id="priority" name="labelIndex.priority" theme="simple" value="labelIndex.priority" list="#{'':'','0':'低','1':'中','2':'高'}"></s:select></td>
				</tr>
				<tr>
				  	<td>&nbsp;操作者&nbsp;：</td>
				...
				<tr>
				  	<td>专题状态：</td>
					<td>
						<s:select id="status" name="labelIndex.status" value="labelIndex.status" theme="simple" list="#{'0':'失效','1':'有效' }">
						</s:select>
					</td>
				</tr> 
				<tr>
					...
					<td>
						<c:choose>
							<c:when test="${labelIndex.site eq 'gome'}">国美</c:when>
				...
				<tr>
					<td>&nbsp;</td>
					<td>
						<input type="button" value="返回" onclick="location.href='${ctx}/Label/listLabelIndex.action'"/> 
