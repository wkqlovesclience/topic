		...
		<div class="mod-1">
			...
			<div class="bd clearfix">
				<div style="margin-bottom: 10px;" class="container-1">
					批量添加搜索词： <input type="file" size="50" id="words" name="words" /> 
					<input type="button" onclick="checkFile()" value="导入热词"/>
					...
					<table class="tb-zebra tmp-class" style="width: 100%;">
						...
						<thead>
							<tr>
								...
								<td style="line-height: 1;">文件名称</td>
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<c:choose>
										<c:when test="${log.site == 'gome'}">国美</c:when>
