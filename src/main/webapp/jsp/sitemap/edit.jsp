...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
  ...
  <body>
    <div class="mod-1">
        <div class="hd">
            <h3>编辑网站地图数据</h3>
            <h3><a href="${ctx}/Sitemap/list.action?page_index=${page_index}"  >返回上一级</a></h3>
        </div>
            ...
            <div class="container-1">
                ...
                <table class="tb-1" style="margin-left: 20px;" width="100%">
                    ...
                    <tr>
                        <td>使用状态：</td>
                        <td>
	                        <s:select id="status" name="sitemap.status" theme="simple" cssStyle="width:80px;" list="#{'':'请选择','Y':'启用','N':'弃用'}" value="sitemap.status">
	                        </s:select>
                        </td>
                    </tr>
                    <tr>
                        <td>删除状态：</td>
                        <td>
                            <s:select id="isDelete" name="sitemap.isDelete" theme="simple" cssStyle="width:80px;" list="#{'':'请选择','0':'未删除','1':'已删除'}" value="sitemap.isDelete">
                            </s:select>
                        </td>
                    </tr>
                    <tr>
                        <td>站点：</td>
                        <td>
                            <s:select id="site" name="sitemap.site" theme="simple" cssStyle="width:80px;" list="siteBaseInfoList" listKey="keyword" listValue="name" headerKey="" headerValue="请选择" value="sitemap.site">
                            </s:select>
                        </td>
                    </tr>
                    <tr>
